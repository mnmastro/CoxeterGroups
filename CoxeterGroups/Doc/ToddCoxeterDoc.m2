document {
	...
	PARA {"The Todd-Coxeter procedure is an incredibly versatile algorithm in computational 
	    ...
	    f: W ---> G where G is a computable group (such as a group of matrices), the Todd-Coxeter
	    procedure can be used among other things to:"}, 
	...
	EXAMPLE {
	 ...
	 SeeAlso => {(map, Group, List), (map, Group, Group, List), 
