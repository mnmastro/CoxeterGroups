...
document {
	...
	PARA {"A Coxeter group is a finitely presented group determined a finite set of generators
	     S such that theonly relations on the generators are of the form (s*t)^m = 1 for some 
...
document {
	...
	PARA {"A Coxeter group is right-angled if every entry of its Coxeter matrix M is 
	    ...
	    in W if and only if the corresponding vertices are adjacent in G."}, 
	
	EXAMPLE {
	    "coxeterGroup pathGraph 5"
	    },

	PARA {"Complete graphs correspond to direct products of copies of ZZ/2."},
	
	EXAMPLE {
	    	"W = coxeterGroup completeGraph 4",
		"groupOrder W"
		},
...
document {
	...
	PARA {"Typically, the dihedral is described as being generated by the reflection s
